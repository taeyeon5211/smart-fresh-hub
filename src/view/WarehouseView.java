...
public class WarehouseView implements Runnable {
    Scanner scanner = new Scanner(System.in);
    DiConfig diConfig = new DiConfig();
    WareHouseController warehouseController = diConfig.getWarehouseController();
    AreaController areaController = diConfig.getAreaController();
